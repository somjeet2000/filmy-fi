...
function Comedy(props) {
  const data = [
    {
      id: 1,
      Image:
        "https://www.highonfilms.com/wp-content/uploads/2022/02/Badhaai-Do-2022.jpeg",
      Title: "Badhai Do",
      Details:
        "Instead of coming out to their families a gay man and a lesbian enter into a marriage of convenience to appease their parents. However chaos soon ensues when the woman's girlfriend comes to live with the unlikely couple.",
    ...
    },
    {
      id: 2,
      Image:
        "https://m.media-amazon.com/images/M/MV5BMGQ0OWM3OTQtMDIwNi00ZTIyLThiMjQtZTBkZTUzZWVhNzBmXkEyXkFqcGdeQWFybm8@._V1_.jpg",
      Title: "Red Notice",
      Details:
    ...
    },
    {
      id: 3,
      Image:
        "https://images-na.ssl-images-amazon.com/images/S/pv-target-images/d7c9a3d8da181b1630747604407eb7ae8b3754713ea6a0dd07d8a11dd4e6e098._UY500_UX667_RI_V_TTW_.jpg",
    ...
    },
    {
      id: 4,
      Image:
        "https://www.denofgeek.com/wp-content/uploads/2021/10/army-of-thieves-ending-explained.jpg?resize=768%2C432",
    ...
    },
    {
      id: 5,
      Image:
        "https://m.media-amazon.com/images/M/MV5BMWQ5NWVmOWYtOWJjZC00MjU3LWFhZDctOTNjZGQ2MDRlNmNmXkEyXkFqcGdeQWRvb2xpbmhk._V1_.jpg",
      Title: "Don't Look Up",
      Details:
    ...
    },
    {
      id: 6,
      Image:
        "https://occ-0-2794-2219.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABRDCAlethJrCS1-arZUSsG73v1gdgbe0ztY70UJfHxB1AKXPut6L2dFYxqmV9V9KnGtm6fNZENhCdj93hB01n_EPzRxq.jpg?r=15e",
    ...
    },
    {
      id: 7,
      Image:
        "https://occ-0-2794-2219.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABV6Ipxy_twPdZt3tHwYsnXQcWPcUwjLPHtMOzpXFNffSaVbwSU4VlPGMOxBxm8h65261PUsODpRGi4-Zvapti_RZCU4I.jpg?r=f4b",
    ...
    },
    {
      id: 8,
      Image:
        "https://netflixjunkie.com/wp-content/uploads/2022/01/through_my_window_ich_sehe_nur_dich.jpg",
    ...
    },
    {
      id: 9,
      Image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqAJJmo2vo0a166n6WwjGBX5ixg_Npn2oSOQ&s",
      Title: "I Care a Lot",
      Details:
    ...
    },
    {
      id: 10,
      Image:
        "https://media.newyorker.com/photos/624c859c1cb684e1ddfebb1f/master/pass/Brody-The-Bubble.jpg",
      Title: "The Bubble",
      Details:
    ...
    },
    {
      id: 11,
      Image:
        "https://media.vanityfair.com/photos/5b9c15c242b9d16f4545a8ef/master/pass/ASF_D10_PI_02154_R3.jpg",
      Title: "A Sample Favor",
      Details:
        "Stephanie, a single mother, along with Sean, Emily's husband, set out to unravel the mystery behind Emily's disappearance. However, they counter secrets much more than what they bargained for.",
      Directors: "Paul Feig",
    ...
    },
    {
      id: 12,
      Image:
        "https://cdn.flickeringmyth.com/wp-content/uploads/2018/05/Zombieland-poster-crop.jpg",
  ...
  const toDetails = (user) => {
    props.history.push("/details/" + user.id + "/" + FormatString(user.Title), {
      itemTitle: user.Title,
      itemDetails: user.Details,
      itemImage: user.Image,
      itemDirectors: user.Directors,
      itemCasts: user.Casts,
    });
  };
