...
function Drama(props) {
  const data = [
    ...
    },
    {
      id: 2,
      Image:
        "https://www.thewrap.com/wp-content/uploads/2021/12/power-936x527.jpg",
    ...
    },
    {
      id: 4,
      Image:
        "https://thatshelf.com/wp-content/uploads/2020/09/Enola-Holmes-feature-image-poster.jpg",
      Title: "Enola Holmes",
      Details:
    ...
    },
    {
      id: 5,
      Image:
        "https://thecinemaholic.com/wp-content/uploads/2020/10/after-we-collided-release-date.png",
    ...
    },
    {
      id: 6,
      Image:
        "https://images.indianexpress.com/2021/01/White-Tiger-review-1200.jpg",
    ...
    },
    {
      id: 7,
      Image:
        "https://1.bp.blogspot.com/-IlnNY2OFE2A/XbxQFutYFoI/AAAAAAAARj8/XrA8YTGdTGcAV1POt1NAZ70-kgTxlfI6gCLcBGAsYHQ/s1600/Black%2Band%2BBlue1.jpg",
      Title: "Black and Blue",
      Details:
        "Witnessing her colleagues killing a drug dealer lands police officer Alicia West into trouble. Falsely accused of the crime, she now has to fight both the corrupt police and evil gangsters.",
    ...
    },
    {
      id: 8,
      Image:
        "https://www.adelaidereview.com.au/app/uploads/2020/03/FILM-The-Platform.jpg",
      Title: "The Platform",
      Details:
    ...
    },
    {
      id: 9,
      Image:
        "https://api.time.com/wp-content/uploads/2017/01/michael-keaton-the-founder-2.jpg",
      Title: "The Founder",
      Details:
    ...
    },
    {
      id: 11,
      Image:
        "https://m.media-amazon.com/images/M/MV5BZDBjNmEzMmEtYjU5NS00NWM4LWE5YmEtNzQzYmIyYjQ4MDc2XkEyXkFqcGdeQXVyMzQ4MTY4Mzk@._V1_.jpg",
      Title: "Lion",
      Details:
    ...
    },
    {
      id: 12,
      Image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVHhA9-RIaJwalUiHxQpAsSRPnUtuOXZsjbg&s",
      Title: "The Big Short",
      Details:
