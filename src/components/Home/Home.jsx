...
function Home(props) {
      ...
      Content: [
        {
          id: 1,
          Image:
            "https://variety.com/wp-content/uploads/2021/07/army-of-the-dead.jpg",
        ...
        },
        {
          id: 3,
          Image:
            "https://img.republicworld.com/tr:w-600,q-75,f-auto/rimages/7fcjioszetqwwqii_1621577144_16_9.jpeg",
        ...
        },
        {
          id: 7,
          Image:
            "https://i0.wp.com/dmtalkies.com/wp-content/uploads/2021/10/ezgif-7-efc8654b6919.jpg?fit=1200%2C675&ssl=1",
          Title: "After We Fell",
          Details:
        ...
        },
        {
          id: 8,
          Image:
            "https://variety.com/wp-content/uploads/2020/10/run-sarah-paulson-kiera-allen.jpg",
          Title: "Run",
          Details:
        ...
        },
        {
          id: 9,
          Image:
            "https://i0.wp.com/bloody-disgusting.com/wp-content/uploads/2021/04/the-unholy-sam-raimi-movie.png?resize=1000%2C585&ssl=1",
          Title: "The Unholy",
          Details:
        ...
        },
        {
          ...
          Title: "Slender Man",
          Details:
            "Fascinated by the Internet lore of the Slender Man, four friends attempt to summon him. However, things get out of hand when one of them mysteriously goes missing.",
        ...
        },
        {
          id: 11,
          Image:
            "https://www.nme.com/wp-content/uploads/2021/03/texas-chainsaw-massacre.jpg",
      ...
      Content: [
        {
          id: 12,
          Image:
            "https://static1.cbrimages.com/wordpress/wp-content/uploads/2022/03/The-Adam-Project-Was-Originally-Set-to-Star-an-Action-Icon.jpg",
        ...
        },
        {
          id: 13,
          Image:
            "https://s3.amazonaws.com/static.rogerebert.com/uploads/review/primary_image/reviews/black-crab-movie-review-2022/black-crab-movie-review-2022.jpeg",
          Title: "Black Crab",
          Details:
  ...
  const toDetails = (subUser) => {
    props.history.push(
      "/details/" + subUser.id + "/" + FormatString(subUser.Title),
      {
        itemTitle: subUser.Title,
        itemDetails: subUser.Details,
        itemImage: subUser.Image,
        itemDirectors: subUser.Directors,
        itemCasts: subUser.Casts,
      }
    );
  };
