...
function Signup(props) {
    ...
    const apiCall = (data) => {
        console.log(data);
        axios.post('http://localhost:80/test.php', JSON.stringify(data))
    ...
    return (
        <div className='signup'>
            { register || <div className='container' style={{textAlign:"center!important"}}>
                ...
                <form className='signupForm'>
                    ...
                    <div style={{color:"white", letterSpacing:'1px', padding:'5px'}}>
                        By clicking Continue, you agree to the FilmyFi <b style={{fontWeight:'normal', color:'#d7c77d'}}>Terms of Use</b> and <b style={{fontWeight:'normal', color:'#d7c77d'}}>Privacy Policy.</b>
                    </div>
                    <button onClick={(event) => handleSubmit(event)} className='signupSubmit' name='submit'>Continue</button>
            ...
            {
                register && <div style={{height:'100px', width:'300px', display:'flex', flexDirection:'column'}}>
                    <label className='registerMsg'>Registered Successfully !!!</label>
                    <Link to='/signin'><button className='registerBtn'>Login</button></Link>
                </div>
            }
        </div>
    );
